...
function ClampToByte(Value: Single): Single; Overload; inline;
function ClampToByte(Value: Integer): Integer; Overload; inline;

function Lerp(Min, Max: Single; Amt: Single = 0.5): Single; Overload; inline;
function Lerp(Min, Max: Integer; Amt: Single = 0.5): Single; Overload; inline;

function InverseLerp(Min, Max: Single; Amt: Single = 0.5): Single; Overload; inline;
function InverseLerp(Min, Max: Integer; Amt: Single = 0.5): Single; Overload; inline;

function Slerp(Min, Max: Single; Amt: Single = 0.5): Single; Overload; inline;
function Slerp(Min, Max: Integer; Amt: Single = 0.5): Single; Overload; inline;
