...
TAppContainer = class(TelContainer)
  ...
  public
    ...
    function Initialize(const aName: String; Width, Height, Bits: Integer; Fullscreen: Boolean; VideoFlag: TelVideoFlag): Boolean; Overload; inline;
    function Initialize(Width, Height, Bits: Integer; Fullscreen: Boolean = false): Boolean; Overload; inline;
...
TelWindow = class(TelObject)
  private
    ...
    procedure SetCaption(Caption: String); inline;
 ...
 // Factory pattern
  TelWindowManager = class(TelObject)
    private
      ...
      function GetCurrentWindow(): TelWindow; inline;
    public
      constructor Create; Override;
      destructor Destroy; Override;
      ...
      function CreateWindow(const aName: String; Width, Height, Bits: Integer; Fullscreen: Boolean = false): TelWindow; Overload; inline;
      function DestroyWindow(aWindow: TelWindow): Boolean; inline;
      procedure DestroyAllWindows(); inline;
    published
...
begin
  ...
  if (Application = nil) then Application := TAppContainer.Create;
