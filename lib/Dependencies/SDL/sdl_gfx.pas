...
function arcColor( dst : PSDL_Surface; x : Sint16; y : Sint16; r : Sint16; start : Sint16; send : Sint16; color : Uint32 ): Integer;
cdecl; external {$IFDEF __GPC__}name 'arcColor'{$ELSE} SDLgfxLibName{$ENDIF __GPC__};
{$EXTERNALSYM arcColor}

function arcRGBA( dst : PSDL_Surface; x : Sint16; y : Sint16; rad : Sint16; start : Sint16; send : Sint16; r : Uint8; g : Uint8; b : Uint8; a : Uint8 ): Integer;
cdecl; external {$IFDEF __GPC__}name 'arcRGBA'{$ELSE} SDLgfxLibName{$ENDIF __GPC__};
{$EXTERNALSYM arcRGBA}
...
function shrinkSurface( src : PSDL_Surface; factorx: Integer; factory: Integer): PSDL_Surface;
cdecl; external {$IFDEF __GPC__}name 'shrinkSurface'{$ELSE} SDLgfxLibName{$ENDIF __GPC__};
{$EXTERNALSYM shrinkSurface}
...
function rotateSurface90Degrees( pSurf : PSDL_Surface; numClockwiseTurns: Integer): PSDL_Surface;
cdecl; external {$IFDEF __GPC__}name 'rotateSurface90Degrees'{$ELSE} SDLgfxLibName{$ENDIF __GPC__};
{$EXTERNALSYM rotateSurface90Degrees}
