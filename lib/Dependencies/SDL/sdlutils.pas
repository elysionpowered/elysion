unit sdlutils;
{
  $Id: sdlutils.pas,v 1.6 2008/04/22 22:12:53 savage Exp $
...
{
  $Log: sdlutils.pas,v $
  Revision 1.6  2008/04/22 22:12:53  savage
  Slight Changes
          ...
          repeat
            ...
            begin
              ...
              begin
				...
				{$IFDEF CPUAMD64}
				//PLongWord( DestAddr )^ := R or G or B;
				{$ELSE}
                PUInt16( DestAddr )^ := R or G or B;
				{$ENDIF}
              end
