...
// Helper macros
//
function DXTRACE_MSG(str: PChar; FileName: PChar = nil; Line: DWORD = $FFFFFFFF): HRESULT;{$IFDEF SUPPORTS_INLINE} inline;{$ENDIF}
function DXTRACE_ERR(str: PChar; hr: HRESULT; FileName: PChar = nil; Line: DWORD = $FFFFFFFF): HRESULT;{$IFDEF SUPPORTS_INLINE} inline;{$ENDIF}
function DXTRACE_ERR_MSGBOX(str: PChar; hr: HRESULT; FileName: PChar = nil; Line: DWORD = $FFFFFFFF): HRESULT;{$IFDEF SUPPORTS_INLINE} inline;{$ENDIF}
...
function DXTRACE_MSG(str: PChar; FileName: PChar = nil; Line: DWORD = $FFFFFFFF): HRESULT;
begin
  Result:= DXTrace(FileName, Line, 0, str, False);
end;

function DXTRACE_ERR(str: PChar; hr: HRESULT; FileName: PChar = nil; Line: DWORD = $FFFFFFFF): HRESULT;
begin
  Result:= DXTrace(FileName, Line, hr, str, False);
end;

function DXTRACE_ERR_MSGBOX(str: PChar; hr: HRESULT; FileName: PChar = nil; Line: DWORD = $FFFFFFFF): HRESULT;
begin
  Result:= DXTrace(FileName, Line, hr, str, True);
end;
{$ENDIF}
