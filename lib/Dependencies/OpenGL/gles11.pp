...
// Additional material from glext /Ingemar
...
// glext
  ...
  const
    ...
    GL_IMG_texture_format_BGRA8888 = 1;    
...
{ $if GL_OES_blend_subtract}
  ...
  var
    glBlendEquationOES : procedure(mode:GLenum);
{ $endif}
{ $if GL_OES_blend_func_separate}

  var
    glBlendFuncSeparateOES : procedure(srcRGB:GLenum; dstRGB:GLenum; srcAlpha:GLenum; dstAlpha:GLenum);
{ $endif}
{ $if GL_OES_blend_equation_separate}

  var
    glBlendEquationSeparateOES : procedure(modeRGB:GLenum; modeAlpha:GLenum);
{ $endif}
{ $if GL_OES_framebuffer_object}
...
(* Const before type ignored *)
    ...
    glGenRenderbuffersOES : procedure(n:GLsizei; renderbuffers:PGLuint);cdecl;
    glRenderbufferStorageOES : procedure(target:GLenum; internalformat:GLenum; width:GLsizei; height:GLsizei);cdecl;
    glGetRenderbufferParameterivOES : procedure(target:GLenum; pname:GLenum; params:PGLint);cdecl;
...
(* Const before type ignored *)
    ...
    glGenFramebuffersOES : procedure(n:GLsizei; framebuffers:PGLuint);cdecl;
    glCheckFramebufferStatusOES : function(target:GLenum):GLenum;cdecl;
    glFramebufferRenderbufferOES : procedure(target:GLenum; attachment:GLenum; renderbuffertarget:GLenum; renderbuffer:GLuint);cdecl;
    glFramebufferTexture2DOES : procedure(target:GLenum; attachment:GLenum; textarget:GLenum; texture:GLuint; level:GLint);cdecl;
    glGetFramebufferAttachmentParameterivOES : procedure(target:GLenum; attachment:GLenum; pname:GLenum; params:PGLint);cdecl;
    glGenerateMipmapOES : procedure(target:GLenum);cdecl;
{ $endif}
{ $if GL_OES_mapbuffer}

  var
    glGetBufferPointervOES : procedure(target:GLenum; pname:GLenum; params: Pointer);cdecl;
